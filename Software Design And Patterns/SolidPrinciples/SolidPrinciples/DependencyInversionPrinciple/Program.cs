...
namespace DependencyInversion
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //ISwitchable door = new Door();

            //Switch lightSwitch = new Switch(lightBulb);
            //Switch doorSwitch = new Switch(door);

            //Console.WriteLine("Operating LightBulb:");
            //lightSwitch.Operate();  // Turns the LightBulb ON
            //lightSwitch.Operate();  // Turns the LightBulb OFF

            //Console.WriteLine("\nOperating Door:");
            //doorSwitch.Operate();   // Opens the Door
            //doorSwitch.Operate();   // Closes the Door
