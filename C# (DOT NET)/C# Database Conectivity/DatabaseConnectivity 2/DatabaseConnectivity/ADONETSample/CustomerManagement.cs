...
namespace ADONETSample
{
    internal class BSCustomerBusinessLogic
    {
        ...
        public int SaveCustomer(Customer customer)
        {
            ...
            int Status = dalObject.InsertUpdateOrDelete(InsertQuery, nvpList);
        ...
        public DataTable FetchCustomerData()
        {
            ...
            DataTable dt = dalObject.FetchAndReturnDataTable(SelectQuery);
            return dt;
        }
        ...
        public int CustomerCount()
        {
            ...
            object countVal = dalObject.FetchScalar(CustomerCountQ);
